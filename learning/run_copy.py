...
if __name__ == "__main__":
    ...
    logging.basicConfig(
        ...
        filename="debug_log/run_autoformer.log",
        filemode="w",
    )
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            logging.info(
                "start training : {}\n\tat {}".format(
                    setting, str(datetime.datetime.now())
                )
            )
            exp.train(setting)
            logging.info("training finished at {}".format(str(datetime.datetime.now())))
            ...
            exp.test(setting)
            logging.info("testing finished at {}".format(str(datetime.datetime.now())))
